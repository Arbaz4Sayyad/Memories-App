# Memories-App
The Memories Project is a full-stack web application built using the MERN stack (MongoDB, Express, React, and Node.js). The app allows users to create, view, and manage memories in the form of posts. Each memory includes a photograph, a description or message, location, tags, and the date of the visit.
